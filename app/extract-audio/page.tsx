...
function MP3ToText() {
  ...
  return (
    <div className="flex justify-start items-center flex-col w-[100vw] h-[100vh] mt-20">
      <Upload {...props}>
      ...
      <div>
        ...
        <p className="rounded-lg bg-gray-200 p-4 min-w-[50vw] max-w-[50vw] min-h-20 mt-2 flex justify-center items-center">
